...
{lambda}    { return new Symbol(sym.LAMBDA, yyline, yycolumn); }  // ← NOUVEAU

"="         { return new Symbol(sym.EGAL,   yyline, yycolumn); }
"<="        { return new Symbol(sym.LTE,    yyline, yycolumn); }  // ← NOUVEAU (avant "<" !)
"<"         { return new Symbol(sym.LT,     yyline, yycolumn); }  // ← NOUVEAU
">"         { return new Symbol(sym.GT,     yyline, yycolumn); }  // ← CORRIGÉ (c'était "<" avant)
">="        { return new Symbol(sym.GTE,    yyline, yycolumn); }  // ← CORRIGÉ (c'était "<=" avant)
"("         { return new Symbol(sym.PAR_G,  yyline, yycolumn); }
")"         { return new Symbol(sym.PAR_D,  yyline, yycolumn); }
","         { return new Symbol(sym.VIRGULE,yyline, yycolumn); }  // ← NOUVEAU
